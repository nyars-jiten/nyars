...
<template>
  <div class="md:flex max-md:grid items-center gap-4">
    ...
    <section class="group relative inline-flex grow flex-row gap-2 rounded-md bg-zinc-800 p-2 leading-none text-zinc-500 shadow-md outline-1 outline-zinc-700 transition-colors focus-within:outline-hidden hover:bg-zinc-700 hover:text-zinc-300 hover:outline-transparent">
      <input
        v-model="request"
        type="text"
