...
const statusVariant1 = '#b3b3b3' // New
const statusVariant2 = '#b31d1d' // Declined
const statusVariant3 = '#1db336' // Accepted
const statusVariant4 = '#1d90b3' // Auto-accepted
...
module.exports = {
  ...
  theme: {
    extend: {
      fontFamily: {
        'app-header-2': ['JetBrains Mono', 'monospace'],
        'app-header': ['Roboto Flex', 'sans-serif'],
        header: [
          '"Exo 2"',
          '"Noto Sans JP"',
  ...
  safelist: [
    ...
    { pattern: /bg-status-variant-/ },
    { pattern: /border-status-variant-/ },
    { pattern: /bg-type-variant-/ },
