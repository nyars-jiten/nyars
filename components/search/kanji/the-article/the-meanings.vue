  ...
  <div class="flex flex-col gap-4">
    ...
    <template v-for="meaning of meanings">
      <div class="flex flex-col gap-y-2">
        ...
        <div v-else>
          <EditableSpan v-model="meaning.title" name="meaning-edit-input" placeholder="значение" />
          ...
          >
            ...
            <span>
              <Button class="font-medium" @click="meaning.readings.push('')">+ чтение</Button>
            </span>
          </span>
          <div>
            <span>Источники: </span>
            <EditInput v-model="meaning.source" name="source-edit-input" placeholder="источники" />
          </div>
        </div>
        <div
          v-if="!isEditor"
        ...
        <TheWords v-else :words="meaning.words" :title="''" />
      </div>
    </template>
  </div>
</template>
