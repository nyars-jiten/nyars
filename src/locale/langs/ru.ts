...
export const ru = {
  ...
  [MessagesNames.KanjiReadingTagName]: {
    shou: { badge: '小', full: 'shou' },
    chuu: { badge: '中', full: 'chuu' },
    kou: { badge: '高', full: 'kou' },
    kanon: { badge: '漢', full: 'kanon' },
    touon: { badge: '唐', full: 'touon' },
    goon: { badge: '呉', full: 'goon' },
    kanyoon: { badge: '慣', full: 'kanyoon' },
    souon: { badge: '宋', full: 'souon' },
    gai: { badge: '外', full: 'gai' }
  },
  ...
  [MessagesNames.IndexSourceAbbr]: {
    nelson_c: "Modern Reader's Japanese-English Character Dictionary (A. Nelson)",
    ...
    halpern_kkld_2ed: "Kodansha Kanji Learner's Dictionary, 2nd Edition (J. Halpern)",
    ...
    henshall: 'A Guide To Remembering Japanese Characters (Kenneth G. Henshall)',
    henshall3: 'A Guide To Reading and Writing Japanese 3rd edition (Henshall, Seele, De Groot)',
  ...
  [MessagesNames.EditsDictName]: ['яп-ру', 'ру-яп', 'кандзи', 'имя', 'яп-ру (авто)', 'пример'],
