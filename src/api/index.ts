import type { TotalStats } from "./types/total-stats";
import type { BestUsers } from "./types/best-users";
...
export const api = new (class {
	public readonly statistics = new StatisticsRest();
	public readonly search = new SearchRest();
})();
