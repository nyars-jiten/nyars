...
<template>
  <header class="sticky top-0 z-50 bg-white shadow-md dark:bg-gray-800">
    ...
    >
      <div class="flex">
        <div class="mr-8 border-r border-gray-100 py-1 pr-8 dark:border-gray-600">
          <RouterLink
        ...
        >
          <RouterLink :to="{ name: RoutesNames.SearchHome }" class="hover:text-accent-500">
            {{ t(MessagesNames.HeaderHome) }}
          </RouterLink>

          <RouterLink :to="{ name: RoutesNames.Edits }" class="hover:text-accent-500">
