        ...
        <v-container v-if="entry.entry">
            <div class="words-header">
                <div class="word" v-for="word in entry.entry.words" :key='word.id'>
                    ...
                    <div class="word-readings">
                        <div class="reading" v-for="reading in word.readings" :key='reading.id'>
            ...
            <div class="entry-sound">
                <template v-if="currentSounds.length > 0">
                    <div class="sound" v-for="currentSound in currentSounds" :key="currentSound">
...
export default {
    ...
    methods: {
        ...
        playAudio(audioLink) {
            const audio = new Audio(`${process.env.VUE_APP_BASE}/upload/sound/${audioLink}`);
            return audio.play();
        },
