    ...
    <div class="user-page">
      ...
      <v-row>
        <v-col cols="12" md="12" sm="12" xs="12">
          <v-card elevation="2" outlined tile v-if="currentUser">
            <v-card-title>
            ...
            <v-card-text>
                ...
                <v-btn color="primary" outlined @click="fileUpload">Загрузить</v-btn>
            </v-card-text>
          </v-card>
        </v-col>
      </v-row>
    ...
    methods: {
        ...
        async fileUpload() {
            ...
            reader.onload = async function () {
                const resp = await sendPostRequest('users/uploadAvatar', { data: reader.result  });
                if (resp.status == 200) {
                    //
                }
            };
